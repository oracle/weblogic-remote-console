...
/**
 * Handles the JAXRS methods for a non-creatable optional singleton child bean's configuration pages.
 */
public class ConfigurationNonCreatableOptionalSingletonResource extends WeblogicBeanResource {

  private static final Logger LOGGER =
    Logger.getLogger(ConfigurationNonCreatableOptionalSingletonResource.class.getName());
   ...
   *       <li>
   *         200 -
   *         the bean exists and was successfully updated.
   *         <p>
