...
/**
  * Customizes the LibraryMBean's createForm's PDJ
  */
/*package*/ class LibraryMBeanCreateFormPDJCustomizer extends BasePageDefinitionCustomizer {

  private static final Logger LOGGER = Logger.getLogger(LibraryMBeanCreateFormPDJCustomizer.class.getName());

  /*package*/ LibraryMBeanCreateFormPDJCustomizer(WeblogicPage page, WeblogicPageSource pageSource) {
    super(page, pageSource);
  }

  /**
    * Customize the library create form PDJ
    */
  ...
  private void addCommonSection() throws Exception {
    ...
    createLibraryMBeanProperty(section, CREATE_FORM_PROPERTY_NAME);
    WeblogicProperty targets = createLibraryMBeanProperty(section, CREATE_FORM_PROPERTY_TARGETS);
  ...
  private void addDeploySection() throws Exception {
    ...
    createLibraryMBeanProperty(section, CREATE_FORM_PROPERTY_SOURCE_PATH);
  }

  private WeblogicProperty createLibraryMBeanProperty(
    FormSection section,
