...
public class JTARuntimeMBeanCustomizer {
  ...
  public static Value forceCommitSelectedTransactions(
    ...
    return SliceTableActionUtils.invokeRowAction(ic, pageActionDef, formProperties, "forceCommit", "xid").getResults();
  }
  ...
  private static JsonArray getCurrentTransactions(InvocationContext ic) {
    ...
    return results.isNull("return") ? null : results.getJsonArray("return");
  }
}
