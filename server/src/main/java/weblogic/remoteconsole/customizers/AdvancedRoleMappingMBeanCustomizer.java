...
public class AdvancedRoleMappingMBeanCustomizer {

  private AdvancedRoleMappingMBeanCustomizer() {
  }

  public static BaseResource createAllResource(InvocationContext ic) {
  ...
  private static class CustomizedCreateHelper extends CreateHelper {
    private String type;
    private String roleMappingName = null;
        ...
        ic.getPageRepo().asPageEditorRepo().create(
          ...
          List.of(
            new FormProperty(
              ...
              new SettableValue(new StringValue(roleMappingName))
            )
          )
        );
    }
    ...
    protected Response<String> getKey(InvocationContext ic, List<FormProperty> properties) {
      // Domain.RealmsSecurityData.<realm>.RoleMappers.<provider>:
      ...
      Path wlsPath =
        (new Path())
          ...
          .childPath(realm)
          .childPath("roleMappers")
          .childPath(provider)
          .childPath("computeRoleMappingName");
      ...
      SecurityResourceMBeanCustomizer.copyStringArg(argsBldr, properties, "roleName");
      ...
      roleMappingName = results.isNull("return") ? null : results.getString("return");
      return (new Response<String>()).setSuccess(roleMappingName);
    }
  }
}
