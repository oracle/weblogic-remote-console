...
public class NavTreeResource extends BaseResource {
  ...
  public javax.ws.rs.core.Response expandNavTreeNodes(InputStream requestBodyStream) {
    JsonObject requestBody = WebAppUtils.readJsonObject(requestBodyStream, getInvocationContext());
