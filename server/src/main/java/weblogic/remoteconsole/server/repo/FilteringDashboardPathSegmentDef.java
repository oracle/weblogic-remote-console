...
/**
 * POJO that holds info about a bean tree path segment of a filtering dashboard
 */
public class FilteringDashboardPathSegmentDef {
  ...
  public FilteringDashboardPathSegmentDef(
  ...
  public FilteringDashboardPathSegmentDef(BeanTreePathSegment segmentTemplate) {
    this.segmentTemplate = segmentTemplate;
  }
