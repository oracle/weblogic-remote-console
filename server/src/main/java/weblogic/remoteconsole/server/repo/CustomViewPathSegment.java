 ...
 */
public class CustomViewPathSegment {

  private CustomViewPathSegmentDef segmentDef;
  private String criteria;
  private String value;

  // Collection segments let the user filter the children's keys:
  public CustomViewPathSegment(
    CustomViewPathSegmentDef segmentDef,
    String criteria,
    String value
  ) {
  ...
  public CustomViewPathSegment(CustomViewPathSegmentDef segmentDef) {
    this.segmentDef = segmentDef;
  }

  // The details of this bean tree path segment
  public CustomViewPathSegmentDef getSegmentDef() {
    return segmentDef;
  }
