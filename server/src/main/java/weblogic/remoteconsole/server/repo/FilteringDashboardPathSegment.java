 ...
 */
public class FilteringDashboardPathSegment {

  private FilteringDashboardPathSegmentDef segmentDef;
  private String criteria;
  private String value;

  // Collection segments let the user filter the children's keys:
  public FilteringDashboardPathSegment(
    FilteringDashboardPathSegmentDef segmentDef,
    String criteria,
    String value
  ) {
  ...
  public FilteringDashboardPathSegment(FilteringDashboardPathSegmentDef segmentDef) {
    this.segmentDef = segmentDef;
  }

  // The details of this bean tree path segment
  public FilteringDashboardPathSegmentDef getSegmentDef() {
    return segmentDef;
  }
