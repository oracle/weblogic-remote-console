...
/**
 * POJO that holds the page property defs related to a bean property for a custom view.
 */
public class CustomViewPropertyDef {
  ...
  public static final String CRITERIA_TRUE = "true";
  public static final String CRITERIA_FALSE = "false";
