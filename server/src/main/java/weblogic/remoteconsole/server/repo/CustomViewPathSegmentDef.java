...
/**
 * POJO that holds info about a bean tree path segment of a custom view
 */
public class CustomViewPathSegmentDef {
  ...
  public CustomViewPathSegmentDef(
  ...
  public CustomViewPathSegmentDef(BeanTreePathSegment segmentTemplate) {
    this.segmentTemplate = segmentTemplate;
  }
