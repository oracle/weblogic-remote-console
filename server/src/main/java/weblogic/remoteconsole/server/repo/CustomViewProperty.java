...
/**
 * POJO that holds information about how to filter a bean property of a custom view.
 */
public class CustomViewProperty {

  private CustomViewPropertyDef propertyDef;
  private String criteria;
  private Value value;

  public CustomViewProperty(
    CustomViewPropertyDef propertyDef,
    String criteria,
    Value value
  ) {
  ...
  public CustomViewPropertyDef getPropertyDef() {
    return propertyDef;
  }
