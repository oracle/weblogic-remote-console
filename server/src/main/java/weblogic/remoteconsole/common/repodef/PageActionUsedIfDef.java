...
/**
 * This interface describes when a page action should be displayed.
 * 
 ...
 */
public interface PageActionUsedIfDef extends UsedIfDef {

  // Returns the corresponding page action.
