...
***
### What's new
The [current release of the WebLogic Remote Console](https://github.com/oracle/weblogic-remote-console/releases) is 2.4.5. This release was published in July 2023.

**New features**

* Simplified upgrade process
* Improved proxy server configuration 
* New version of WebLogic Remote Console extension: console-rest-ext-5.0.war
