...
***
### What's new
The [current release of the WebLogic Remote Console](https://github.com/oracle/weblogic-remote-console/releases) is 2.2.0. This release was published in February 2022.

**New features**

* New providers!
    * WDT composite models: see the properties of combined WDT model files
    * Property lists: edit key-value property pairs
...
* Improved Monitoring Tree perspective: review runtime statistics aggregated across servers
    * The Servers page replaces the Server States and Running Servers pages
