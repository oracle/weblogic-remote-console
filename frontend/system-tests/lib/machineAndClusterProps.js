...
//MLW            await driver.findElement(By.xpath("//tr[3]/td/oj-button/button/div/span/span")).click();
            await driver.findElement(By.xpath("//tr[3]/td/oj-selector/span/input")).click();
            await driver.sleep(1200);
