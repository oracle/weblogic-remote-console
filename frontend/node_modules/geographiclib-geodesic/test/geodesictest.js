...
describe("geodesic", function() {
  ...
  describe("GeodesicSolve", function () {
    ...
    it("GeodSolve100", function() {
      ...
      var geod = new g.Geodesic(1e6, -3),
          inv = geod.Inverse(30, 0, 30, 180);
      // Sloppy bounds checking because series solution is inaccurate for
      // ellipsoids this eccentric.
      assert.approx(inv.azi1,  22.368806, 1.0);
      assert.approx(inv.azi2, 157.631194, 1.0);
      assert.approx(inv.s12,   1074081.6, 1e3);
    });
