...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      'ojs': path.resolve(__dirname, './web/js/libs/oj/19.0.1/debug'),
      'ojtranslations': path.resolve(__dirname, './web/js/libs/oj/19.0.1/resources'),
    ...
    new WebpackRequireFixupPlugin(
      {
        ...
        baseResourceUrl: "./web/js/libs/oj/19.0.1"
      }
    )
