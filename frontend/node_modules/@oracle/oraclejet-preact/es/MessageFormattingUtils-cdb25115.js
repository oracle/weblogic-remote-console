...
import { c } from './stringUtils-0fe25200.js';
...
function isValidValueForProp(value, prop = 'string') {
    switch (prop) {
        ...
        default:
            ...
            return typeof value === 'string' && !c(value);
    }
}
/**
...
export { formatTimestamp as f, isValidValueForProp as i, severities as s };
//# sourceMappingURL=MessageFormattingUtils-cdb25115.js.map
