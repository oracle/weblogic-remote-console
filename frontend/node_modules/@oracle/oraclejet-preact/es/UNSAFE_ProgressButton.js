...
import { P as ProgressButtonLabelLayout } from './ProgressButtonLabelLayout-875f1282.js';
...
import './useProgressButtonLabelLayoutTheme-7ce1cf07.js';
...
import './ProgressCircle-9f9dc011.js';
import './meterUtils-cd7cf089.js';
import './utils-ca3e7eba.js';
...
const ProgressButton = forwardRef(({ variant = 'outlined', isLoading = false, isDisabled = false, size = 'md', display = 'all', type: buttonType = 'button', startIcon, edge, testId, onAction, label = '', tooltip, 'aria-describedby': ariaDescribedBy, width, ...props }, ref) => {
    ...
    const content = (jsx(ProgressButtonLabelLayout, { display: display, isLoadingContrast: variant === 'callToAction', startIcon: startIcon, accessibleLoadedLabel: progressComplete, accessibleLoadingLabel: progressStatus, size: size, isLoading: isAdjustedLoading, children: label }));
    ...
    return (jsxs(Fragment, { children: [jsx(BaseButton, { ...mergeProps(ttProps, globalEventProps), ref: ref, elementDetails: elementDetails, isDisabled: isDisabled, isReadOnly: isAdjustedLoading, size: size, width: width, edge: edge, variant: variant, styling: labelOnly
                    ...
                    : isAdjustedLoading
                        ? ['noHoverActive', 'min']
                        : ['min'], onAction: onAction, "aria-label": label, testId: testId, children: content }), tooltipContent] }));
});
