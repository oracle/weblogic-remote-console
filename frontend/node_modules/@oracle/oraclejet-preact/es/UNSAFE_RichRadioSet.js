...
import { B as BaseRichSelection } from './BaseRichSelection-253b1661.js';
import 'preact/hooks';
 ...
 */
const RichRadioSet = forwardRef(({ children, onCommit, value, ...otherProps }, ref) => {
    const baseId = useId();
    return (jsx(RadioSetContext.Provider, { value: {
            name: baseId,
            value,
            onCommit
        }, children: jsx(BaseRichSelection, { ...otherProps, baseId: baseId, ref: ref, selection: "single", value: value, children: toChildArray(children).map((child, index) => (
