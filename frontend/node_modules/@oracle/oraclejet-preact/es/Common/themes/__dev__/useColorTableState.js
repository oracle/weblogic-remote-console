...
import { _ as _curry3 } from '../../../_curry3-577eb45e.js';
import { c as curryN } from '../../../curryN-dd9b9bee.js';
import { e as equals, k as keys } from '../../../equals-625352e8.js';
...
const reducer = (state, action) => {
    switch (action.type) {
        ...
        case 'toggleSection': {
            return {
                ...state,
                collapsedSections: ifElse$1(includes$1(action.section), reject$1(equals(action.section)), (arr) => [...arr, action.section])(state.collapsedSections)
            };
        }
        default: {
            return state;
