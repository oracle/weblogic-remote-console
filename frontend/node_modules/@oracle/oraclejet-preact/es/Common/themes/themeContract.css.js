...
var densityVars = {density:{units:'var(--oj-c-EXPERIMENTAL-DO-NOT-USE-density-units)'}};
var dvtVars = {label:{sm:{fontSize:'var(--oj-c-EXPERIMENTAL-DO-NOT-USE-label-sm-font-size)'},md:{fontSize:'var(--oj-c-EXPERIMENTAL-DO-NOT-USE-label-md-font-size)'},lg:{fontSize:'var(--oj-c-EXPERIMENTAL-DO-NOT-USE-label-lg-font-size)'}},dimmedOpacity:'var(--oj-c-EXPERIMENTAL-DO-NOT-USE-dimmed-opacity)'};
