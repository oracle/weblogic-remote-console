...
import { v as getCumulativeSeries, n as getSeriesData, o as getLineAreaSegments, i as findNearestDataPoint, j as getStartAndEndAxesOffset, m as getMarkers } from './utils-adfaaca0.js';
import { A as AreaSeries, g as getLineAreaChartItemPosition } from './chartUtils-474e9229.js';
import { L as LineSeries, M as MarkersWithLabel } from './LineSeries-5ee0f790.js';
import { e as getLineAreaChartNavUtil, d as getItemColor, f as getMarkerType } from './dataStyleUtils-a529150d.js';
...
import { c as colorSchemeVars } from './themeContract.css-2b5a42e2.js';
import { C as Chart } from './Chart-a834358f.js';
...
import './TrackResizeContainer-4411f745.js';
...
import './useChartViewport-923b7ae0.js';
...
import './useChartNav-ed40e12b.js';
...
import './useSelectDrill-9027a3a5.js';
import './useChartDataCursor-82b836ed.js';
import './hooks/PRIVATE_useChartDataCursor/themes/DataCursorStyles.css.js';
import './DataCursorStyles.styles.css';
import './useChartDatatip-a3ce4e23.js';
...
import './cssUtils-20795e7b.js';
import './useChartContextMenu-92d9028b.js';
...
import './useChartDnd-5937eef0.js';
...
import './useChartMarquee-2d60324d.js';
import './useVisDragModeControls-92ddac92.js';
 ...
 */
function LineAreaChart({ width, height, selectedIds = [], hiddenIds = [], highlightedIds, hideAndShowBehavior = 'none', orientation = 'vertical', yAxis, y2Axis, series, groups, isStacked = false, getDataItem, selectionMode = 'none', drilling = 'off', type = 'line', overview = 'off', dataLabelEffect = 'outline', ...props }) {
    ...
    return (jsx(Chart, { width: width, height: height, selectedIds: selectedSet, hiddenIds: hiddenIds, hideAndShowBehavior: hideAndShowBehavior, orientation: orientation, yAxis: yAxis, y2Axis: y2Axis, series: series, groups: groups, selectionMode: selectionMode, drilling: drilling, isStacked: isStacked, getDataItem: getDataItem, findNearest: findNearest, getDataItemPos: getDataItemPos, getMarkerInfo: getMarkerColorAndType, renderGridLinesInFront: isAreaRendered, getNavUtil: getNextChartItemFunc, getGapRatio: getGapRatio, getStartAndEndAxesOffset: getOffset, isRtl: isRtl, overview: overview, defaultOverviewContentRenderer: () => {
            ...
            return (jsxs(Fragment, { children: [renderedSeries.map((lineAreaSeries, index) => {
                        ...
                        return (jsxs(Fragment, { children: [isAreaRendered && (jsx(AreaSeries, { yScale: isAssociatedToY2 ? y2Scale : yScale, lineType: seriesItem.lineType, color: seriesItem.areaColor || colors[index % colors.length], isHorizontal: isHoriz, areaColorOpacity: areaOpacity, isBottomSegmentCurved: isBottomSegmentCurved, bottomCoords: prevCoords !== undefined &&
                                ...
                                !isStacked && (jsx(MarkersWithLabel, { yScale: isAssociatedToY2 ? y2Scale : yScale, xScale: xScale, groups: leafGroups, series: seriesItem, timeAxisType: timeAxisType, color: seriesItem.lineColor ||
                                        ...
                                        : undefined, isSelectionEnabled: selectionMode === 'single' || selectionMode === 'multiple', isDrillEnabled: drilling === 'on', defaultFontSize: defaultFontSize, dataLabelEffect: dataLabelEffect, isHighContrast: isHighContrast, isTestEnv: isTestEnv, getTextDimensions: getTextDimensions, getItemAriaLabel: getItemAriaLabel }))] }));
                    }), isStacked &&
