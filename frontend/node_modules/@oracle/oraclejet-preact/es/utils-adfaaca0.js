...
import { a as rgb, r as rgba } from './utils-cfef1929.js';
import { g as getLocale } from './getLocale-1c41e86a.js';
import { l } from './stringUtils-0fe25200.js';
import { A as AXIS_DEFAULTS, g as getGroupAxisLabelsInfo, s as skipLabelsGreedy, u as updateLabelsDims, a as getTickLabelInfo, b as getDataAxisLabelsInfo } from './labelUtils-aee6ab65.js';
...
function getTimeAxisProps(groups, position, availSpace, viewportMin, viewportMax, averageInterval, isRtl, xAxis, axisFontSize, getTextDimensions, isTimeAxis) {
    ...
    if (isLabelRendered) {
        ...
        if (isLabel1Rendered) {
            ...
            updateLabelsDims(label1MaxWidth, label1MaxHeight, tickLabels1, getAxisPos, availSpace, position);
        ...
        if (isLabel2Rendered) {
            ...
            updateLabelsDims(label2MaxWidth, label2MaxHeight, tickLabels2, getAxisPos, availSpace, position);
...
export { getScrollBarSpace as a, getLayoutInfo as b, updateScrollBarSpace as c, getAvailSpace as d, getOuterGaps as e, findSeriesGroupIndexFromId as f, getAxesPosition as g, getBarGapRatio as h, findNearestDataPoint as i, getStartAndEndAxesOffset as j, getBarGapsInfo as k, getMixedFreqGroupCenter as l, getMarkers as m, getSeriesData as n, getLineAreaSegments as o, getCmdPoints as p, isNonCurvedLine as q, getLabelPosition as r, getGroupCenterCoord as s, getMarkerFillAndStroke as t, updateViewportFromOverview as u, getCumulativeSeries as v };
//# sourceMappingURL=utils-adfaaca0.js.map
