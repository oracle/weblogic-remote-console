...
import { c as cloneDimension } from './dimensionUtils-6d5dac30.js';
 ...
 */
function getTextInfo(text, textStyle, width, height, isMultiline, minChar, getTextDimension) {
    const lines = isMultiline
        ? truncateMultilineText(text, textStyle, width, height, minChar, getTextDimension)
        : [truncateSingleLineText(text, textStyle, width, height, minChar, getTextDimension)];
    const lineHeight = getTextDimension(REPRESENTATIVE_TEXT, textStyle).height;
...
export { truncateSingleLineText as a, getTextProps as b, centerTextInAvailSpace as c, getTextInfo as g, positionMultilineText as p, truncateMultilineText as t };
//# sourceMappingURL=utils-49903d04.js.map
