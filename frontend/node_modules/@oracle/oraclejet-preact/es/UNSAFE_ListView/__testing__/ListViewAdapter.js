...
import { findMenu } from '../../UNSAFE_Menu/__testing__/index.js';
...
import '../../UNSAFE_Menu/__testing__/MenuAdapter.js';

class ListViewAdapter extends TestAdapter {
    /**
    ...
    async doToggleSelection(key) {
        ...
        let item;
        try {
            item = await (await this.getElement()).waitForElement(byCss(`[data-oj-key="${key.toString()}"]`));
        }
        catch {
