...
import { baseStyle, styles } from './PRIVATE_Resizable/themes/ResizableStyles.css.js';
...
function Resizable({ onResize, onResizeStart, onResizeEnd, containerRef, constraints }) {
    ...
    const resizingEdge = useRef(ResizeEdge.NONE);
    const startPosition = useRef();
    const initialParentClientRect = useRef({ x: 0, y: 0, width: 0, height: 0 });
     ...
     */
    const constrainRect = useCallback((srcRect) => {
     ...
     */
    const getNewRect = useCallback((event) => {
        let left = 0;
        let width = 0;
        let top = 0;
        let height = 0;
    ...
    return (jsxs(Fragment, { children: [jsx("div", { class: classNames([baseStyle, styles.handleN]), onMouseDown: startResizeN }), jsx("div", { class: classNames([baseStyle, styles.handleE]), onMouseDown: startResizeE }), jsx("div", { class: classNames([baseStyle, styles.handleS]), onMouseDown: startResizeS }), jsx("div", { class: classNames([baseStyle, styles.handleW]), onMouseDown: startResizeW }), jsx("div", { class: classNames([baseStyle, styles.handleNE]), onMouseDown: startResizeNE }), jsx("div", { class: classNames([baseStyle, styles.handleSE]), onMouseDown: startResizeSE }), jsx("div", { class: classNames([baseStyle, styles.handleSW]), onMouseDown: startResizeSW }), jsx("div", { class: classNames([baseStyle, styles.handleNW]), onMouseDown: startResizeNW })] }));
}

export { Resizable as R };
//# sourceMappingURL=Resizable-b88279bc.js.map
