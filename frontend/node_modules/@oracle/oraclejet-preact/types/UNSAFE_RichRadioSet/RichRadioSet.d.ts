 ...
 * @ignore
 */
import { type ComponentChildren, type ComponentProps, type Ref, type JSX } from 'preact';
...
type Props = TestIdProps & Pick<UnpackSignals<JSX.AriaAttributes>, 'aria-describedby'> & {
    /**
 ...
 */
export declare const RichRadioSet: import("preact").FunctionalComponent<import("preact/compat").PropsWithoutRef<Props> & {
