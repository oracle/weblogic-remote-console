 ...
 */
export declare function FitMeterCircle({ max, min, value, step, size, startAngle, angleExtent, isTrackRendered, thresholdDisplay, indicatorSize, testId, isReadonly, ...props }: MeterProps): import("preact").JSX.Element;
