...
export type ButtonSetMultipleProps = ButtonIntrinsicProps & WidthProps & TestIdProps & {
    /**
 ...
 */
export declare const ButtonSetMultiple: import("preact").FunctionalComponent<import("preact/compat").PropsWithoutRef<ButtonSetMultipleProps> & {
