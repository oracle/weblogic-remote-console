...
export declare function GanttDesktopTaskAccContent<K1, K2, D1 extends GanttRowData<K1, D1, D2>, D2 extends GanttTaskData<K2>>({ width, height, rowData, dateFormatter, ariaActiveId, ariaActiveTaskObj }: Props<K1, K2, D1, D2>): import("preact").JSX.Element;
export {};
