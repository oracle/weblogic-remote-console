import { CalendarDate } from "../../utils/UNSAFE_calendarDateUtils";
import { TestAdapter } from '@oracle/oraclejet-testing/UNSAFE_TestAdapter';
export declare class InputDateMaskAdapter extends TestAdapter {
    /**
     ...
     * @returns Promise<void>
     */
    changeValue(value: CalendarDate | undefined): Promise<void>;
}
