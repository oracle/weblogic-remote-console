...
var chartUtils = require('./chartUtils-84b671f7.js');
var LineSeries = require('./LineSeries-4c97a793.js');
var dataStyleUtils = require('./dataStyleUtils-8c59d570.js');
var useUser = require('./useUser-f900ddf1.js');
var colorUtils = require('./colorUtils-c97cf90b.js');
require('./accUtils-5c7d3255.js');
var themeContract_css = require('./themeContract.css-a53fd740.js');
var BarGroup = require('./BarGroup-234f35bf.js');
var Chart = require('./Chart-376785c5.js');
...
require('./TrackResizeContainer-100be103.js');
...
require('./useChartViewport-d2e8c46f.js');
...
require('./useChartNav-b079ab1e.js');
require('./layoutUtils-e52005dc.js');
require('./useVisHover-ad36112d.js');
require('./useSelectDrill-b818e267.js');
require('./useChartDataCursor-363a537d.js');
require('./hooks/PRIVATE_useChartDataCursor/themes/DataCursorStyles.css.js');

require('./useChartDatatip-76d4aeaa.js');
...
require('./cssUtils-3318fbe2.js');
require('./useChartContextMenu-a8c6d928.js');
...
require('./useChartDnd-2c152d6b.js');
require('./utils-6f32ac40.js');
...
require('./useChartMarquee-02a04456.js');
require('./useVisDragModeControls-56c2f3c3.js');
...
require('./OverviewSlidingWindow-09c08dc9.js');
require('./PRIVATE_VisOverview/themes/VisOverview.css.js');

require('./DragH-7667516a.js');
 ...
 */
function ComboChart({ width, height, selectedIds = [], hiddenIds = [], highlightedIds, hideAndShowBehavior = 'none', orientation = 'vertical', yAxis, series, groups, isStacked = false, getDataItem, selectionMode = 'none', drilling = 'off', dataItemGaps = 0.5, dataLabelEffect = 'outline', ...props }) {
    ...
    const getDataItemPos = (xScale, yScale, y2Scale, axisStepWidth, averageGroupZ, gapRatio) => {
        const _getBarPosition = hasBar
            ? BarGroup.getBarPosition(filteredBarSeries, groups, getDataItem, xScale, yScale, y2Scale, hiddenSet, dataItemGaps, axisStepWidth, averageGroupZ, gapRatio, yAxis?.scale === 'log', isStacked, isRtl, isHoriz, isSplitDualY, timeAxisType)
            : undefined;
    ...
    return (jsxRuntime.jsx(Chart.Chart, { width: width, height: height, selectedIds: selectedSet, hiddenIds: hiddenIds, hideAndShowBehavior: hideAndShowBehavior, orientation: orientation, yAxis: yAxis, series: series, defaultOverviewContentRenderer: () => {
            return jsxRuntime.jsx(OverviewComboChart, { groups: groups, series: series, getDataItem: getDataItem });
        }, groups: groups, selectionMode: selectionMode, drilling: drilling, isStacked: isStacked, getDataItem: getDataItem, findNearest: findNearest, getDataItemPos: getDataItemPos, getMarkerInfo: getMarkerColorAndType, renderGridLinesInFront: hasArea, getNavUtil: getNextChartItemFunc, getGapRatio: getGapRatio, getStartAndEndAxesOffset: getOffset, isRtl: isRtl, ...props, children: ({ xStartIndex, xEndIndex, xScale, groupsInfo, yScale, y2Scale, activeId, focusedItemInfo, hoveredItemInfo, isPointInsideMarquee, getTextDimensions, defaultFontSize, axisStepWidth, averageGroupZ, getItemAriaLabel, plotAreaClipPathId }) => {
            ...
            return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: renderedSeries.map((valueSeries, index) => {
                    ...
                    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [currentSeries.type === 'bar' &&
                            ...
                            !isStacked && (currentSeries.type === 'line' || isAreaRendered) && (jsxRuntime.jsx(LineSeries.MarkersWithLabel, { yScale: isAssociatedToY2 ? y2Scale : yScale, xScale: xScale, groups: leafGroups, series: currentSeries, timeAxisType: timeAxisType, color: colors[index % colors.length] /* TODO : make this use getItemColor function from dataStyleUtils. */, seriesIndex: index, startIndex: xStartIndex, endIndex: xEndIndex, markerType: markers[index % markers.length], orientation: orientation, isLog: isLog, activeId: activeId, getDataItem: getDataItem, isPointInsideMarquee: isPointInsideMarquee, selectedIds: selectedSet, focusedItemIndex: focusedItemInfo.seriesIndex === index &&
                                    ...
                                    : undefined, isSelectionEnabled: selectionMode === 'single' || selectionMode === 'multiple', isDrillEnabled: drilling === 'on', defaultFontSize: defaultFontSize, dataLabelEffect: dataLabelEffect, isHighContrast: isHighContrast, getItemAriaLabel: getItemAriaLabel }))] }));
                }) })
