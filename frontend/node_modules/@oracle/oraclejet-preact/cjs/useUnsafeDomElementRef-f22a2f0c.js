...
function useUnsafeDomElementRef(unsafeRootElementRef) {
    const extractedRef = hooks.useRef(null);
    ...
    if (unsafeDomHandle?.[unsafeDomAccess.UNSAFE_DOM_ACCESS]) {
        current = unsafeDomHandle[unsafeDomAccess.UNSAFE_DOM_ACCESS];
    }
...
exports.useUnsafeDomElementRef = useUnsafeDomElementRef;
//# sourceMappingURL=useUnsafeDomElementRef-f22a2f0c.js.map
