...
var popupUtils = require('./popupUtils-488fe8f7.js');
...
const Modal = ({ children, isOpen, onBackdropClick, backdropVariant }) => {
    ...
    return isOpen ? (jsxRuntime.jsx(Layer.Layer, { isModal: true, children: jsxRuntime.jsxs("div", { ref: modalRef, class: UNSAFE_Modal_themes_ModalStyles_css.baseStyle, onFocus: handleFocusIn, children: [jsxRuntime.jsx(ModalBackdrop, { ref: backdropRef, variant: backdropVariant }), children] }) })) : null;
};

exports.Modal = Modal;
//# sourceMappingURL=Modal-0cea796e.js.map
