...
class NativeParserImpl {
    ...
    static _matchPMSymbol(cal, matchGroup) {
        ...
        if (NativeDateTimeConstants._zh_tw_locales.includes(loc)) {
            ...
            const upperMatchGroupNoSpace = toUpper(matchGroup).replace(/\s/g, '');
            const upperCalPMNoSpace = toUpper(calPM).replace(/\s/g, '');
...
//# sourceMappingURL=getFormatParse-88bacc78.js.map
