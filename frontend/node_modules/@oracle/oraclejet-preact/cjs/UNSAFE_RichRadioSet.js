...
var BaseRichSelection = require('./BaseRichSelection-1d4ef67b.js');
 ...
 */
const RichRadioSet = compat.forwardRef(({ children, onCommit, value, ...otherProps }, ref) => {
    const baseId = useId.useId();
    return (jsxRuntime.jsx(RadioItemContext.RadioSetContext.Provider, { value: {
            name: baseId,
            value,
            onCommit
        }, children: jsxRuntime.jsx(BaseRichSelection.BaseRichSelection, { ...otherProps, baseId: baseId, ref: ref, selection: "single", value: value, children: preact.toChildArray(children).map((child, index) => (
