...
import { SelectSingleWebElement } from './SelectSingleWebElement';
export { SelectSingleWebElement };
/**
 ...
 */
export declare function findSelectSingle(driver: DriverLike, by: By): Promise<SelectSingleWebElement>;
