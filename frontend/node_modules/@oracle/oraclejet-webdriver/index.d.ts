...
declare const ojwd: {
     ...
     */
    get(driver: WebDriver, url: string): Promise<void>;
    /**
     * @deprecated
     ...
     */
    waitAndFindElement(driver: DriverLike, by: By): Promise<WebElement>;
    assertViewModelValue: typeof assertViewModelValue;
};
export default ojwd;
