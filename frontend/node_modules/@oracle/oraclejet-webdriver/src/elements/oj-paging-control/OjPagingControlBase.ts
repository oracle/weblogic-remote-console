...
export class OjPagingControlBase extends OjWebElement {
   ...
   * @deprecated Since 7.0.0. Support for "loadMore" paging mode is deprecated. Use native component high-water mark scrolling APIs instead (see Table, ListView, and DataGrid for details). In addition, "loadMore" is not compatible with the Table, Listview, and DataGrid default scroll-policy "loadMoreOnScroll".
   */
