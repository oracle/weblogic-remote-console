 ...
 */
export declare class OjDatePickerBase extends OjWebElement {
    /**
     ...
     *
     */
    getDatePicker(): Promise<DatePicker>;
    /**
     ...
     * @deprecated Since 8.0.0. Support for "native" mode rendering is deprecated because JET promotes a consistent Oracle UX based upon the Redwood design system. As a result, the theme variable "$inputDateTimeRenderModeOptionDefault" is also deprecated.
     */
     ...
     * The today-time-zone attribute is used to compute today's date. It defaults to the user's system timezone.
...
export interface PickerAttributes {
    ...
    /**
     *
     * @deprecated Since 7.0.0. Style property of pickerAttribute violates the recommended Content Security Policy for JET which disallows inline styles. Use class property instead. As of 11.0.0 this property is ignored and an error is logged.
     */
    style: string;
}
