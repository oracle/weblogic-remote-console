...
export { OjFilePicker };
/**
 * Retrieve an instance of [OjFilePicker](../classes/elements.OjFilePicker.html).
 * @example
 * ```javascript
 ...
 */
export declare function ojFilePicker(driver: DriverLike, by: By): Promise<OjFilePicker>;
