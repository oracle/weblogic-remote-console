 ...
 */
export declare class OjAccordionBase extends OjWebElement {
    /**
     ...
     *
     */
    changeExpanded(expanded: Array<string> | Array<number> | Array<object> | null): Promise<void>;
    /**
     ...
     *
     */
    getExpanded(): Promise<Array<string> | Array<number> | Array<object> | null>;
    /**
     ...
     *
     */
    getTranslations(): Promise<object | null>;
}
