...
async function assertViewModelValue(driver, vmLocator, expectation) {
    ...
    const result = await (0, oj_module_proxy_1.executeWithModules)(driver, ['Chai', 'Knockout', 'CspExpressionEvaluator'], [viewmodelEl, expectation.assertion], (chai, ko, ExpressionEval, viewmodelEl, assertion) => {
        try {
            ...
            if (value && typeof value.then === 'function') {
                return value.then(compare).catch((ex) => ex.message);
            }
            else {
