...
import { MeterBarWebElement } from './MeterBarWebElement';
export { MeterBarWebElement };
/**
 ...
 */
export declare function findMeterBar(driver: DriverLike, by: By): Promise<MeterBarWebElement>;
