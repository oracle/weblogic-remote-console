define({
  "root": {
    ...
    "wrc-footer": {
      "text": {
        "copyrightLegal": "Copyright (c) 2020, 2026, Oracle and/or its affiliates.<br/>Oracle (r), Java, MySQL, and NetSuite are registered trademarks of Oracle and/or its affiliates. Other names may be trademarks of their respective owners.<br/>",
    ...
    "wrc-content-area-header": {
      ...
      "title": {
        "home": "Home",
        "edit": "Edit Tree",
        "serverConfig": "Configuration View Tree",
        "domainRuntime": "Monitoring Tree",
        "securityData": "Security Data Tree",
        "model": "WDT Model",
        "compositeConfig": "WDT Composite Model",
    ...
    "wrc-recently-visited": {
      ...
      "messages": {
        "pageNoLongerExists": {
          ...
          "detail1": "You have been redirected here because ",
          "detail2": "The requested resource was deleted by another user, or no longer exists. "
        }
      }
    },
    "wrc-pages-bookmark": {
    ...
    "wrc-common": {
      ...
      "labels": {
        ...
        "pagesBookmark": {
          ...
          "notreachable": {
            "value": "This page is not available given the current provider."
          }
        }
      },
      "placeholders": {
    ...
    "wrc-pdj-fields": {
      "cfe-multi-select": {
        ...
        "buttons": {
          "add": {
            "tooltip": "Move selected items from Available to Chosen"
          },
          "addAll": {
            "tooltip": "Move all items from Available to Chosen"
          },
          "remove": {
            "tooltip": "Move selected items from Chosen to Available"
          },
          "removeAll": {
            "tooltip": "Move all items from Chosen to Available"
          }
        }
      },
    ...
    "wrc-navtree": {
      "labels": {
        "showless": "Show Less",
        "showmore": "Show all ({0} more)",
        "root": "Root"
      },
      "ariaLabel": {
        "provider": "Navigation for {0}",
        "default": "Choose a navigation item"
      }
    },
    "wrc-content": {
      "ariaLabel": {
