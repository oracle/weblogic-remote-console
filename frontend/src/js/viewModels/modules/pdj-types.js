    ...
    PageDataTypes.prototype = {
      ...
      getConvertedObservableValue: function(propertyName, readValue) {
        ...
        if (this.isArray(propertyName) && this.isStringType(propertyName)) {
          return Utils.getArrayOfStringConvertedValue(readValue, "\n");
        }
        ...
        switch(this.getType(propertyName)) {
          ...
          case 'properties':
            if (readValue !== "") {
              ...
              result = Utils.getPropertiesConvertedValue(readValue, "\n");
            }
            break;
        ...
        switch(this.getType(propertyName)) {
          ...
          case 'properties':
            if (displayValue == null) {
              ...
              result = Utils.getPropertiesDisplayValue(value, "\n");
            }
            break;
          case 'string':
            result = value;
            if ((displayValue != null) && this.isArray(propertyName)) {
              ...
              result = Utils.getArrayOfStringDisplayValue(value, "\n");
            }
            break;
          case 'int':
            result = value;
        ...
        if (value != null) {
          if (this.isArray(propertyName)) {
            ...
            if (this.isReferenceType(propertyName)) {
              value = Utils.getArrayOfNamesFromCollectionChild(value);
            }
            // All other array types display using the string conversion for that type
            displayValue = Utils.getArrayOfStringDisplayValue(value, ", ");
          } else {
            // The value is NOT an array
            if (this.isReferenceType(propertyName)) {
              displayValue = Utils.getNameFromCollectionChild(value);
            }
            else if (this.isPropertiesType(propertyName)) {
              displayValue = Utils.getPropertiesDisplayValue(value, ", ");
