...
define(['knockout',  'ojs/ojarraydataprovider', '../../../apis/data-operations', '../../../core/runtime', '../../../microservices/page-definition/utils', '../../../core/cbe-types', '../../../core/cbe-utils', 'ojs/ojlogger', 'ojs/ojknockout'],
  function (ko, ArrayDataProvider, DataOperations, Runtime, PageDefinitionUtils, CbeTypes, CbeUtils, Logger) {
        ...
        $.getJSON(viewParams.parentRouter.data.rdjUrl() + "?slice=" + sliceParam)
          ...
          .then(
            function () {
              ...
              $.getJSON(pdjUrl)
                .then((pdjData) => {
                    self.sliceName = PageDefinitionUtils.getSliceFromPDJUrl(pageDef);
