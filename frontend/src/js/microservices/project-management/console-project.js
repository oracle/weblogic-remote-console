 ...
 * @module
 */
define(['../provider-management/data-provider-manager', '../provider-management/data-provider', '../../core/utils', '../../core/cfe-errors', '../../core/types'],
      ...
      this.dataProviders.forEach((item) => {
        ...
        switch(item.type) {
          ...
          case DataProvider.prototype.Type.MODEL.name:
            ...
            if (CoreUtils.isNotUndefinedNorNull(item.fileContents)) dataProvider["fileContents"] = JSON.stringify(item.fileContents);
            break;
        }
