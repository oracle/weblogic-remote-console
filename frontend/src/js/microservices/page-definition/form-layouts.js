...
define(['ojs/ojcore', '../../core/utils', 'ojs/ojlogger'],
  ...
  //public:
    return {
       ...
       */
      SectionsPropertyNotFoundError: function SectionsPropertyNotFoundError(message, extra) {
      ...
      hasFormLayoutSections(pdjData) {
        let rtnval = false;
        if (CoreUtils.isNotUndefinedNorNull(pdjData) && CoreUtils.isNotUndefinedNorNull(pdjData.sliceForm)) {
      ...
      hasFormLayoutType: function(pdjData, key) {
        let rtnval = false;
        if (CoreUtils.isNotUndefinedNorNull(pdjData.sliceForm) && CoreUtils.isNotUndefinedNorNull(pdjData.sliceForm.presentation)) {
