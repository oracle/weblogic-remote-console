...
define(['ojs/ojcore', 'knockout', 'ojs/ojmodule-element-utils', '../../core/runtime', '../data-management/cbe-data-storage', '../../apis/data-operations', '../../apis/message-displaying', './utils', '../../core/utils', '../../core/cbe-types', 'ojs/ojlogger'],
  function (oj, ko, ModuleElementUtils, Runtime, CbeDataStorage, DataOperations, MessageDisplaying, PageDefinitionUtils, CoreUtils, CbeTypes, Logger) {
        ...
        return DataOperations.mbean.new(uri)
          .then(reply => {
            ...
            return ModuleElementUtils.createConfig({
              name: "content-area/body/overlay-form-dialog",
              params: {
