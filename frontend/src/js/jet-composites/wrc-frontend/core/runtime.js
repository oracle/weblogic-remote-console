 ...
 */
define(['./parsers/yaml', 'text!wrc-frontend/config/console-frontend-jet.yaml', 'text!baseUrl', './cbe-types', './types', './utils', 'ojs/ojlogger'],
  function (YamlParser, ConfigFileContents, BaseUrl, CbeTypes, CoreTypes, CoreUtils, Logger) {
