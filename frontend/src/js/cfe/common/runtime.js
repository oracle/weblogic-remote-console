...
define(['ojs/ojlogger', '../io/adapter', '../cbe-types', './types', 'text!../../baseUrl'],
  function (Logger, FileAdapter, CbeTypes, Types, BaseUrl) {
    var properties = {};
    var config = {};

    properties['console-frontend.mode'] = Types.Console.RuntimeMode.OFFLINE.name;
    properties['console-frontend.isReadOnly'] = false;
    properties['console-backend.domain'] = "";
    properties['console-backend.domainConnectState'] = Types.Domain.ConnectState.DISCONNECTED.name;
