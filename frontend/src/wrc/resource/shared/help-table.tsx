        ...
        <>
          ...
          <ul>
            {helpTopics.map((helpTopic) => (
              <li key={`${helpTopic.label}-${helpTopic.href}`}>
                <HelpLink href={helpTopic.href}>{helpTopic.label}</HelpLink>
              </li>
            ))}
          </ul>
        </>
...
const ExternalHelpDetail = ({
  ...
  return externalHelp ? (
    <p>
      ...
      <br />
      <code>
        <HelpLink href={externalHelp.href}>{externalHelp.label}</HelpLink>
      </code>
    </p>
  ) : (
    <></>
