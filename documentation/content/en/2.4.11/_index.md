...
***
### What's new in WebLogic Remote Console 2.4.11

This release was published in August 2024.
...
For simplicity, we have changed the versioning scheme of the WebLogic Remote Console extension to match that of WebLogic Remote Console. The WebLogic Remote Console extension is now `console-rest-ext-2.4.11.war`. 
