...
To install the WebLogic Remote Console, follow the instructions at [Get Started](../setup).

{{% details summary="It's also possible, though not recommended, to use console.zip to run the WebLogic Remote Console as a browser application."%}}
