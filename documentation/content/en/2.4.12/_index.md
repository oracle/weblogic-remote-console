...
However, although the WebLogic Remote Console and the WebLogic Administration Console are similar, there are differences between them. See [Differences](setup/admin-console-diff) for details on how they differ.

### Get started {id="get_started"}

It's simple to install the WebLogic Remote Console and get up and running within moments. See [Install WebLogic Remote Console](setup) for instructions.

***
### What's new in WebLogic Remote Console 2.4.12

This release was published in October 2024.
...
For simplicity, we have changed the versioning scheme of the WebLogic Remote Console extension to match that of WebLogic Remote Console. The WebLogic Remote Console extension is now `console-rest-ext-2.4.12.war`. 
